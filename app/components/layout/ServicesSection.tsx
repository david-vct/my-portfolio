    ...
    <section className="relative flex flex-col place-content-center w-full max-w-7xl min-h-[80svh] p-4 md:p-16 mt-16 overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 place-content-center">
        {services.map((service, index) => (
          <div
            key={index}
            className="group relative flex flex-col gap-6 p-8 bg-base/30 backdrop-blur-sm rounded-md border border-white/10 overflow-hidden transition-all duration-300 hover:-translate-y-2 hover:border-accent/60 hover:shadow-2xl hover:shadow-accent/20"
          >
